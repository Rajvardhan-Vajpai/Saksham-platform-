...
async function initDashboardShell({ role, active, title, crumb }) {
  ...
  document.getElementById("sidebar").innerHTML = `
    <div class="brand">
      <div class="brand-emblem"><img src="assets/images/saksham-bharat-logo.png" alt="Saksham Bharat Logo" class="brand-logo-img"></div>
      <div class="brand-text"><div class="brand-name">Saksham Bharat</div><div class="brand-sub">Training &amp; Competency Platform</div></div>
    </div>
